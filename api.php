...
namespace Tqdev\PhpCrudApi {
    ...
    $config = new Config([
        ...
        // 'port' => '3306',
        'username' => 'u843230181_group7_2', // 'root',
        'password' => 'Zugzwang6969', // '',
        'database' =>  'u843230181_test2', // 'test3',
        'middlewares' => 'customization,validation,json,authorization,apiKeyDbAuth',
        'validation.tables' => 'all',
        "apiKeyDbAuth.mode" => "required",
        "apiKeyDbAuth.usersTable" => "sessions",
        "apiKeyDbAuth.apiKeyColumn" => "session_id",
        // 'customization.afterHandler' => function ($operation, $tableName, $response, $environment) {
        //     $arr = json_decode($response->getBody()->getContents(), true);
        //     return ResponseFactory::fromObject(200,  $arr['records'], true);
        // },
        'authorization.columnHandler' => function ($operation, $tableName, $columnName) {
            return !($tableName == 'users' && ($columnName == 'pw_hash' || $columnName == 'pw_type' || $columnName == 'email_verification_code'));
        },
        'authorization.recordHandler' => function ($operation, $tableName) {
            return ($tableName == 'users') ? 'filter=role_id,neq,1' : '';
        },
        'debug' => true
    ]);
